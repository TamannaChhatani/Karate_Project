...
/*.table1 tr tr td:nth-child(even)
{
    border-color: red;
}*/ 
...
function getPlayerNames($bracket, $player, $final)
{
    ...
    foreach ($brackets as $bracket) {
       ...
       // echo " $data[1] to $data[2]  years - $data[0]- $data[3] BELT (.$data[4].)";
     //  echo "dataaa ";
       // $data[1] ."to". $data[2] ." years -". $data[0]."-". $data[3]." BELT (".$data[4].")";
        //print_r($data);
        ...
        echo "<tr><td style='padding:0px; border: 0 none; border: 2px solid ;'><table class='corner'><tr>";
        echo "<th>No</th>";
        ...
        for ($j = 0; $j < count($bracket); $j++) {
            ...
            echo "<td style='border:10px solid red;' >$corner[0]</td>";
            echo "</tr>";
            echo "<tr>";
...
function setplayers($participantsCount, $bouts, $bracketSize, $requiredByes, $flag, $new, $final)
{
    ...
    foreach ($finals as $final) {
        ...
        for ($yas = 1; $yas <= $bracketSize / ceil($bouts); $yas++) {
            ...
            echo "<td>$corner[0]</td>";
            echo "</tr>";
            echo "<tr style='border:2px  solid blue; border-top-color: blue;'>";
        ...
        foreach ($final as $f) {
            ...
            echo "<tr >";
            echo "<td style='border:2px solid black;'>" . $f['coach'];
            echo "</td>";
            echo "<td style='border:2px solid black;'>" . $f['player_name']  . "</td>";
            echo "</tr>";
            //  echo "<td>" . $c2;
            //  echo "<td>" .   $pl2 . "</td>";
            //  echo "</td></tr>";
        ...
        // echo "<table id='win' style=' border-style:none; border:0px;'  class='winner' >";
        // echo "<tr>";
        // echo  "<th> Winner </th>";
        // echo "<th>Sign </th>";
        // echo "</tr>";
