...
-->
        ...
        <span>
            ...
            <input type="radio" name="kata" value="yes" style="margin-left: 12px;">Yes
            <input type="radio" name="kata" value="no" >No
        ...
        <span>
            ...
            <input type="radio" name="kata" value="yes" style="margin-left: 2px;">Yes
                    <input type="radio" name="kata" value="no" >No
        ...
        <span>
          ...
          <br>
          <span>
            <input class="label" id="submit" type="submit" value="Display" name="display"  />
          </span>
          <br> 
      </div>
