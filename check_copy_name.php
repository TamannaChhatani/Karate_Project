        ...
        else
        {
            ...
            foreach($pl_name as $pn)
            {
              ...
              //  echo "<br> Array values===";
               // print_r(array_values($pn));
               // echo"<br>in".$in;
                foreach ($pl_name as $pl_key => $pl_array) {​​​​​​​

                 echo "<br>current key:". $pl_key;

                    foreach ($pl_name as $search_key => $search_array) {​​​​​​​

                        if ($search_array[0] == $pl_array[0]) {​​​​​​​

                            if ($search_key != $pl_key)
                             {​​​​​​​
                                echo" <br>duplicate found:". $search_key;
                            }
                        }
                    }
                    echo "<br>";
