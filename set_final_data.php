...
<head>
    ...
    <link rel="stylesheet" href="bracket_css.css">
...
function getPlayer_Names($bracket, $player,$data)
{
  //  echo "<br> player ::";
    ...
    $g_count = f_count(count($bracket));
    $pl_name = array();
    echo "<br> Hello from get player name ";
    $z = 1;
    array_unshift($player, array('Bye', '-'));
    //  $group_list = array_chunk($player, ceil(count($player) / 2));
    ...
    foreach ($bracket as $brc) {
        ...
        echo "<td >" . $c1;
        echo "</td>";
        echo "<td class='game game-top'>" . $pl1  . "</td>";
        echo "</tr>";
        echo "<tr class='spacer'>";
        echo "<td>" . $c2;
        echo "<td class='game game-bottom'>" .   $pl2 . "</td>";
        echo "</td></tr>";
...
else if(isset($coach) && !empty($coach))
{
    ...
    getPlayer_Names($bracket, $player,$data);
