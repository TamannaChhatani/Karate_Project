...
<body>
    <form name="form" onsubmit= "return validate();" method="POST" id="form" style="font-family: 'Courier New';font-weight:bold;">
     <!--  <table>
            <tr>
...
<label for="name">Name:</label>
	  ...
	  <label>Gender:</label>
	  <input type="radio"  value="Male" name="gender"><label for="Male" class="light">Male</label><br>
	  <input type="radio"  value="Female" name="gender"><label for="Female" class="light">Female</label>
	  ...
	  <input type="date" name="competitiondate" id="competitiondate" min="2021-01-01" disabled >
	...
	<select id="belt" name="belt">
		<option value="">Select Belt </option>
						...
						<label>Kata:</label>
						<input type="radio"  value="Yes" name="kata"><label for="Yes" class="light">Yes</label>
						<input type="radio"  value="No" name="kata"><label for="No" class="light">No</label>
						
						<label>Kumite:</label>
						<input type="radio"  value="Yes" name="kumite"><label for="Yes" class="light">Yes</label>
						<input type="radio"  value="No" name="kumite"><label for="No" class="light">No</label>
