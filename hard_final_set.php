...
if (isset($_POST['display'])) {
    ...
    if ($kata == 'yes' && $kumite == 'yes') {
       ...
       array_push($data, $gen, $minage, $maxage, $belt, $minweight,$maxweight,$fight);
...
$participantsCount = count($participants);
    ...
    //    echo "</tr>";
        echo " <tr>
            ...
            <th>Kata</th>
            <th> Kumite</th>
            <th id='asc_coach' > Coach/District/State</th>
            </tr>";
...
function setplayers($participantsCount, $bouts, $bracketSize, $requiredByes, $flag, $new, $final,$data)
{
    ...
    foreach ($finals as $final) {
        ...
        echo "<tr><td Colspan='2'><span class='table_title'>4th Wado National Karate Championship -2021<span></td></tr> ";
        ...
        if (isset($data[4]) && !empty($data[4]) && isset($data[4]) && !empty($data[5])) {
            $info[] .= "[" .$data[4] . " to " . $data[5] . " Kg]";
        }
        ...
        echo "<tr><td colspan='2'>  <span class='table_title'> " . " Pool-" . $beta ." ". $info[0] . $info[1] . $info[2] . $info[3] ;
        echo "</td></tr></span>";
        echo"<span>";
        ...
        echo "</tbody>";
        echo "</table></td>";
        echo "<td style='padding:0px;border: 0 none;'><table  class='$class table2 tab_ch' ><tr><th>Coach Name </th>";
        echo "<th>Player name</th>";
        echo "</tr>";
        echo "<tbody class='sortable'>";
