<head>
    ...
    <link rel="stylesheet" href="design_karate.css">
</head>
<main id="tournament">
   ...
   for($i=1;$i<=8;$i++){
       ...
       echo " <li class='game game-top winner'> <span>79</span></li>";
       echo "<li class='game game-spacer'></li>";
       echo " <li class='game game-bottom '><span>79</span></li>";
       echo "".$i;
    ...
    //     <li class="game game-top winner">Mich St <span>65</span></li>
        ...
        // for($i=1;$i<=2;$i++){
            ...
            //     echo " <li class='game game-top winner'> </li>";
            //     echo "  <li class='game game-spacer'>&nbsp;</li> ";
            //     echo "  <li class='game game-bottom '> </li>";
        // }
        // echo "</ul>";
