...
<head>
    <title></title>
    <link rel="stylesheet" href="design_change.css">
        ...
        function sorting(n) {
          ...
          //  alert("in sorting");
            ...
            while (switching) {
                ...
                for (i = 2; i < rows.length - 1; i++) { //Change i=0 if you have the header th a separate table.
...
<!-- <body>
    <input type="button" id="show" name="show" onclick="myFunction()" >
...
if (isset($_POST['display'])) {
  ...
  $result = mysqli_query($mysqli, $sql);
   ...
   $participants = range(1, $row);
    $participantsCount = count($participants);  
    if ($row > 0) {
        echo "<table id='win' class='data_table'>";

        echo "<tr>";
        echo "<th>Count </th>";
        echo "<th>".$participantsCount ."</th>";
        if ($gen) {
...
$bracket = getBracket($participants, $player, $new,$data);


function getBracket($participants, $player, $new,$data)
{
    $participantsCount = count($participants);
   ...
   //  echo sprintf('Number of participants: %d<br/>%s', $participantsCount, PHP_EOL);
    ...
    setplayers($participantsCount, $bouts, $bracketSize, $requiredByes, $flag, $new, $final,$data);
...
function setcoach($bouts, $bracketSize, $participantsCount, $requiredByes, $flag, $final, $sub_val)
{
    ...
    while (($final[$pl_set] != "")) {
        ...
        if ($final[$pl_set]['coach'] == $sub_val['coach']) {
            ...
            } else if ($final[set_mid($m2, $high + 1)] == "") {
                $pl_set = set_mid($m2, $high + 1);
            ...
            } else if ($final[set_mid($m28, $high + 1)] == "") {
                $pl_set = set_mid($m28, $high + 1);
            ...
            } else if ($final[set_mid($m30, $high + 1)] == "") {
                $pl_set = set_mid($m30, $high + 1);
...
function setplayers($participantsCount, $bouts, $bracketSize, $requiredByes, $flag, $new, $final,$data)
{
    //$flag=0;
    //  $flag = (($flag * 32) >= $bracketSize) ? 0 : $flag;
    //$flag++;
    ...
    foreach ($finals as $final) {
        ...
        echo "<section class='tik'>";

        //echo " <div class='page'>";
        //echo " <div class='subpage'>";
        echo "<table class = 'page' style = margin-top: 0px; >";
        echo "<tr><td Colspan='2'>4th Wado National Karate Championship -2021 </td></tr> ";
        ...
        echo "dataa";print_r($data);
        echo "<tr><td colspan='2'>" . "     Pool-" . $beta ." ". $info[0] . $info[1] . $info[2] . $info[3] ;
        echo "</td></tr>";
        
        echo "<tr><td style='padding:0px; border: 0 none;'><table class='table1'><tr>";
        echo "<th>No</th>";
        echo "<th> Corner </th></tr>";
        
        $class++;
        for ($yas = 1; $yas <= $bracketSize / ceil($bouts); $yas++) {
        ...
        $beta++;
        echo "</table></td>";
        echo "<td style='padding:0px;border: 0 none;'><table  class='$class table2' ><tr><th>Coach Name </th>";
        echo "<th>Player name</th>";
        echo "</tr>";
        echo "<tbody class='sortable'>";
        ...
        // echo "<table id='win' class='border_none' >";
        // echo "<tr>";
        // echo  "<th> Winner </th>";
        // echo "<th>Sign </th>";
        // echo "</tr>";
        ...
        // echo "<tr>";
        // echo "<td>1.________________________________________</td>";
        // echo "<td>________________________________________</td>";
        // echo "</tr>";

        // echo "<tr>";
        // echo "<td>2.________________________________________</td>";
        // echo "<td>________________________________________</td>";
        // echo "</tr>";

        // echo "<tr>";
        // echo "<td>3.________________________________________</td>";
        // echo "<td>________________________________________</td>";
        // echo "</tr>";
...
echo"<div id='win'>";
echo"<p style='font-weight:bold; font-size:12px;'>  &nbsp;  &nbsp;   &nbsp;  &nbsp;Winner    &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; sign</p>";
echo"<p>1.________________________________________  ________________________________________</p>";
echo"<p>2.________________________________________  ________________________________________  </p>";
echo"<p>3.________________________________________  ________________________________________ </p>";
echo"<p>3.________________________________________  ________________________________________</p>";
echo"</div>";
...
function design($bracketSize)
{
    ...
    if ($bracketSize == 4) {
        ...
        echo "<main class='t'  style = 'margin-left: 516px; top : 100px' >";
    } else {
        echo "<main class='t'  style = 'margin-left : 516px; >";
    ...
    if ($bracketSize >= 32) {
        ...
        for ($i = 1; $i <= 8; $i++) {
            ...
            echo " <li class='game game-top winner'  style='height: 37px;'> <span>&nbsp;</span></li>";
            echo "<li class='game game-spacer'></li>";
            echo " <li class='game game-bottom '  style='height: 37px'><span>&nbsp;</span></li>";
            //  echo  " <li class= 'spacer'>&nbsp;</li>";
        }
        echo "</ul>";
        ...
        for ($i = 1; $i <= 4; $i++) {
            ...
            echo " <li class='game game-top winner'> <span></span></li>";
            echo "  <li class='game game-spacer'>&nbsp;</li> ";
            echo "  <li class='game game-bottom '> <span></span></li>";
    ...
    if ($bracketSize >= 4 && $bracketSize <= 16) {
        echo "<ul class='round round-4'>";
        for ($i = 1; $i <= 1; $i++) {
